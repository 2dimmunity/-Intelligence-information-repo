...
def GDC(pred_depth, gt_depth, calib,
    ...
    #return also gt_depth identifying information
    return new_depth_map, (gt_depth > 0)

if __name__ == '__main__':
    predict = np.load("/home/u00277/Pseudo_Lidar_V2/results/sdn_kitti_train_set/depth_maps/trainval/000000.npy")
    gt = np.load( "/home/u00277/data/KITTI_64pseudo/depth_map/000000.npy")
    calib = Calibration("/home/u00277/data/KITTI_64pseudo/training/calib/000000.txt")

    GDC(predict, gt ,calib )
