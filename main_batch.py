...
def GDC_and_mask_save(func, save_path, save_path2, *args, **kwds):
    corrected_depth, binary_mask = func(*args, **kwds)
    np.save(save_path2, binary_mask.astype(np.bool))
...
def main(args):
    ...
    if args.threads <= 1:
        for idx in tqdm(idx_list):
            ...
            save_path2 = osp.join(args.output_path2, "{:06d}".format(idx))
            ...
            GDC_and_mask_save(GDC, save_path ,save_path2 , predict, gt, calib,
                          W_tol=3e-5, recon_tol=args.recon_tol,
                        k=args.k, method=args.method, subsample=args.subsample)
    else:
        # multiprocessing
        ...
        for idx in idx_list:
            ...
            res.append((idx, pool.apply_async(
                ...
                GDC_and_mask_save, args=(GDC, save_path,save_path2, predict, gt, calib),
